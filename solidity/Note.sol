...
import "https://github.com/OpenZeppelin/openzeppelin-solidity/contracts/payment/PaymentSplitter.sol";
...
contract Note is  IERC20{
    ...
    function pay() external payable {
        ...
        totalDistributions = totalDistributions + msg.value;
        emit TotalDistributionsChanged(totalDistributions);
    }
...
//////////////
    ...
    function _addPayee(address account, uint256 shares_) public {
        ...
        _totalSupply = _totalSupply.add(shares_);
